...
### 🟢 AB1 — The Income Engine

AB1 is the **consistent quarterly income** bucket. While AB3 sits patiently in its 2-year LEAP position, AB1 works constantly in the background — selling short-dated option spreads to collect time decay (theta) every week or two.

Think of it like renting out a parking space while you wait for your beach house to appreciate. Small, steady, predictable income.

- **How it works:** You sell option spreads with 1–30 day expiry. These are small, defined-risk trades — you know the maximum loss before you enter. You collect premium upfront and make money as time passes and the options decay toward zero.
- **Capital allocation: ≤10% of portfolio** (not counting the AB3 LEAPs behind any PMCC)
- **Entry gate:** The CRS (Call Ripeness Score) must be 7 or higher, and the LOI must be in the income window (not the deep accumulation zone — you don't sell income trades at the absolute bottom)
- **Max holding period: 30 days.** If a trade needs more time than that, it becomes AB2.
- **PMCC income leg:** When you sell a short-dated call against an existing AB3 LEAP (Poor Man's Covered Call), that short call is classified as AB1 income.
...
### 🟠 AB2 — The Conviction Bet

AB2 is reserved for moments of **high directional confidence**. When the engine detects that MSTR is significantly overextended in one direction — either overvalued and due for a pullback, or massively undervalued and about to break out — AB2 deploys a focused directional trade.

These are not frequent. AB2 fires maybe once per quarter, when the evidence is overwhelming. But when it fires, it fires with conviction.

- **Capital allocation: ≤10% of portfolio** (standalone capital, separate from AB3)
- **Holding period:** 30 days minimum; typically 90+ days for LEAP-style structures
- **Entry triggers:**
  - Force Field showing **BOUNCE EXHAUST** (credit metrics overextended, 93% historically bearish)
  - A clear CT1/CT2 pre-breakout setup with Force Field confirming early recovery
  - Extreme LOI readings at a confirmed structural turn
- **Structures (simple only):** Long puts, bear call spreads, bull put spreads, or directional LEAP calls. Maximum two legs. No complexity.
...
**The current season (2026-03-09): 🌧️ Turbulence**
...
### Layer 0.75 — Force Field (The Wind Conditions)

Between the macro season (Layer 0.5) and the road conditions (Layer 1), there's one more layer unique to MSTR: the **Force Field**.

MSTR is not a normal stock — it's essentially a leveraged Bitcoin holding company. Its price is driven not just by BTC and macro, but by very specific forces: the health of Saylor's preferred stock credit, the relative strength of MSTR vs. its closest competitor IBIT, and the flow of money into and out of stablecoins.

The Force Field measures these five forces simultaneously and combines them into a single reading called **F_net**:

| Force | What It Measures |
|---|---|
| STRF/LQD ratio | Saylor's credit quality vs. the investment-grade bond market |
| MSTR/IBIT ratio | Is MSTR gaining or losing ground vs. Bitcoin ETFs? |
| STRC | Are Saylor's preferred holders getting nervous? |
| Stablecoin Dominance | Is money flowing into safe stablecoins (bearish) or out (bullish)? |
| MSTR price itself | Sanity check — does price agree with the forces? |

**Five zones:**

| Zone | Reading | Reliability |
|---|---|---|
| 🔵 STRONG BULL | F_net > -0.19 | ⚠ Provisional — not yet validated in bull markets |
| 🟢 MOD BULL | F_net > -0.60 | ⚠ Provisional |
| ⬜ NEUTRAL | between -1.15 and -0.60 | Monitoring only |
| 🔴 MOD BEAR | F_net < -1.15 | ✓ HIGH confidence — 75% correct over next 10 days |
| 🟥 STRONG BEAR | F_net < -1.66 | ✓ HIGH confidence — 76% correct over next 10 days |

**The "Bounce Exhaustion" warning:** When the Force Field shows STRONG BULL *but* MSTR's price is still more than 10% below its structural resistance level, the engine flags this as **BOUNCE EXHAUST** — meaning the credit metrics have temporarily improved on a bounce, but there's still a wall of resistance above. Historically, 93% of BOUNCE EXHAUST readings are followed by MSTR declining over the next 20 days. It looks bullish. It isn't.

> **Analogy:** Imagine a car engine that's rev-ing up but the wheels are in deep mud. The engine sounds great. The car isn't going anywhere yet.
...
| Alert | Meaning |
|---|---|
| 🎯 AB3 Buy | Stage 2 bottom confirmed. Buy 2-year LEAPs now. |
| 🟢 AB1 Gate Open | CRS ≥7, income conditions met. Start selling short credit spreads. |
| 🟠 AB2 Conviction Signal | Force Field BOUNCE EXHAUST or pre-breakout confirmed. Directional trade opportunity. |
| 🔴 AB1 Gate Closed | LOI dropped into deep accumulation. Stop writing income trades. |
| ⚠️ AB3 Trim | LOI hit a trim level. Sell 25% of LEAP position. |
| 🟥 BOUNCE EXHAUST | Force Field shows false bull — price below structural resistance. Historically 93% bearish at 20 days. |
...
| 🐻 Force Field → Bear Zone | External force conditions turned bearish. Reduce sizing confidence on new entries. |
...
| AB3 target allocation | ~50% | Core structural position |
| AB2 max allocation | ≤10% | Directional conviction trades |
| AB1 max allocation | ≤10% | Theta income (excludes AB3 LEAP long leg) |
| AB1 + AB2 combined | ≤20% | Hard combined cap |
