# ABFv2.0 — Uncommitted Edits Captured for Salvage (2026-05-01)

> **Status: SUPERSEDED — captured for line-by-line salvage migration into v3.2.2 docs.**
>
> This file preserves the uncommitted edits made to `briefs/allocation-bucket-framework-v2.0.md`
> in Cyler's workspace clone before that clone was reset to origin/main on 2026-05-01.
>
> Per Cyler's 2026-05-01 assessment: the v2.0 framework is **superseded** as governing
> architecture by v3.2.2 (AB4 = benchmark anchor, AB3 = deviation layer atop AB4, Howell
> phase profiles drive posture). The doctrine fragments below are **not** to be adopted as
> current operating doctrine. They contain decisions Gavin marked APPROVED that may still
> warrant migration into the current v3.2.2 doctrine stack (`briefs/p-ab3-ruleset-v1.md`,
> `briefs/p-sri-v322-build-design-v1.md`, etc.) on a fragment-by-fragment basis.
>
> **Salvage candidates flagged by Cyler for review:**
> - Quality assets bypassing the RP1 gate
> - Stronger yield objective framing (2%/month)
> - Concentration / correlation guardrails (5% single-position cap)
> - AB2 bear spread program approval
>
> **Original file content with uncommitted edits follows verbatim:**
